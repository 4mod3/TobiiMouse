...
void MouseIntegration::OnClick(tobii_validity_t left_valid, tobii_validity_t right_valid, int64_t time_stamp)
{

    if((left_valid ^ right_valid) && (LastLeft || LastRight))
    {
...
void MouseIntegration::HeadRot(float r_x, float r_y, float r_z)
{
